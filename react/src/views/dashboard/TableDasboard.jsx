...
function TableDasboard() {
    ...
    const getData = () => {
        axiosClient.get(`/Facture?page=${page}&q=${query}&order=${order}&DESC=${DESC}&row=${maxRows}`)
                        ...
                        {dataF?.data?.map((f, index) =>
                            ...
                            <tr key={index} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td className="px-6 py-4 flex justify-center  ">
                                    <Link to={`/afficheFacture/${f.id}`} data-modal-toggle="delete-user-modal" className="text-white me-2 bg-green-600 hover:bg-green-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                        Afficher
                                    </Link>
                                    <button onClick={() => updateFact(f.id)} type="button" data-modal-toggle="user-modal" className="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 me-2 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
