...
function TableDasboard() {
    ...
    const getData=()=>{
        axiosClient.get('/Facture').then(reponse=>setData(reponse.data)) 
    }
    useEffect(()=>{
        getData()
    },[])
...
data?.map((f,index)=>
                ...
                <button type="button" data-modal-toggle="user-modal" class="text-white bg-cyan-600 hover:bg-cyan-700 focus:ring-4 focus:ring-cyan-200 me-2 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
